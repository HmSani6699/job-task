...
const CountDown = () => {
  return (
    <div className="bg-light">
      <section className="py-1  text-center countDown-container">
          ...
          <div className="row  mt-5">
            ...
            <div className="col-md-3 mb-4 count-box">
              <div className="p-4 bg-white rounded shadow h-100">
                ...
                <p className="text-success mb-0">Experts Advisors</p>
              </div>
            </div>
            <div className="col-md-3 mb-4 count-box">
              <div className="p-4 bg-white rounded shadow h-100">
                ...
                <p className="text-success mb-0">Premium Lectures</p>
              </div>
            </div>
            <div className="col-md-3 mb-4 count-box">
              <div className="p-4 bg-white rounded shadow h-100">
                ...
                <p className="text-success mb-0">Global Students</p>
              </div>
            </div>
          </div>
        </div>
